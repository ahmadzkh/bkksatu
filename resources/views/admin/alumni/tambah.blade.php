            ...
            <div class="data me-4">
                ...
                <form action="" class="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control rounded-15" id="nis" onkeyup="updateNis(this.value)" maxlength="12" name="nis">
                    </div>
                    <div class="mb-3">
                        <label for="nisn" class="form-label">NISN</label>
                        <input type="number" class="form-control rounded-15" id="nisn" onkeyup="updateNisn(this.value)" maxlength="12" name="nisn">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control rounded-15" id="tahunmasuk" onchange="updateTahunmsk(this.value)" name="tahunmasuk">
                    </div>
                    <div class="mb-3">
                        <label for="tahunlulus" class="form-label">Tahun Lulus</label>
                        <input type="date" class="form-control rounded-15" id="tahunlulus" onchange="updateTahunlls(this.value)" name="tahunlulus">
                    </div>
                    <div class="blue-line rounded-20 mb-3"></div>
                    <h3 class="fw-700 mb-2">Data Akun</h3>
                    <div class="mb-3">
                        <label for="username" class="form-label">Username</label>
                        <input type="text" class="form-control rounded-15" id="username" placeholder="Username..." name="username">
                    </div>
                    <div class="mb-3">
